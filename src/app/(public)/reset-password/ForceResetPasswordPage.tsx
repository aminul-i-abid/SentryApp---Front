...
const schema = z
	.object({
		email: z.string().email('Debes ingresar un email válido').nonempty('Debes ingresar tu email'),
		password: z
			.string()
...
function ForceResetPasswordPage() {
	...
	const savedEmail = localStorage.getItem('force_reset_email') || '';
	...
	// Efecto para limpiar el localStorage después de montarse el componente
	useEffect(() => {
		return () => {
