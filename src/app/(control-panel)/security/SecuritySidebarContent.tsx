...
type SecuritySidebarContentProps = {
	className?: string;
	onSetSidebarOpen: (open: boolean) => void;
};

function SecuritySidebarContent(props: SecuritySidebarContentProps) {
	...
	return (
		<Root>
			<div className={clsx('m-8 mr-6 flex items-center justify-between sm:my-10', className)}>
				<Typography className="text-4xl font-extrabold leading-none tracking-tight"> Security</Typography>
				{isMobile && (
					<IconButton
			...
			<FuseNavigation navigation={SecurityNavigation.children} />
		</Root>
	);
}

export default SecuritySidebarContent;
