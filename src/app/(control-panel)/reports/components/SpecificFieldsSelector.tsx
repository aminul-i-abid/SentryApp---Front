      ...
      <CardHeader
        ...
        subheader={
          <Typography variant="body2" sx={{ color: "#64748b", mt: 1 }}>
            ...
            <br />
            Los campos por defecto del Excel generado son: Nombre y Apellido del
            Huésped, Check-in, Check-out, Habitación, Bloque y Estado de la
            Reserva.
          </Typography>
        }
      />
