...
const AuditorySmsTable = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await getSmsLogs(page + 1, rowsPerPage); // API usa 1-based indexing
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ fontSize: '0.8rem', fontWeight: 600 }}>Teléfono</TableCell>
              ...
              <TableCell sx={{ fontSize: '0.8rem', fontWeight: 600 }}>Fecha Acción</TableCell>
