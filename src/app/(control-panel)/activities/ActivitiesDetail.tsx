        ...
        try {
            ...
            if (isNew) {
                ...
                if (response.succeeded) {
                    ...
                    dispatch(showMessage({
                        message: response.message?.join(', ') || t('errors.createActivity'),
                        variant: 'error'
                    }));
                }
            } else if (id) {
                ...
                if (response.succeeded) {
                    ...
                    dispatch(showMessage({
                        message: response.message?.join(', ') || t('errors.updateActivity'),
                        variant: 'error'
                    }));
                }
            }
            ...
            dispatch(showMessage({
                message: isNew ? t('errors.createActivity') : t('errors.updateActivity'),
                variant: 'error'
            }));
        } finally {
            setSaving(false);
                        ...
                        <Paper className="p-6">
                            <ActivityForm
                                initialData={activity ? {
                                    ...
                                    cancellationDeadlineHours: activity.cancellationDeadlineHours
                                } : undefined}
