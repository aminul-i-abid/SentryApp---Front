...
const BlockOccupancyCard = ({ blockData }) => (
    <Paper 
        elevation={0} 
        sx={{ 
            p: 3, 
...
function Dashboard() {
    ...
    const handleOpenLostBedsSidebar = () => { setIsLostBedsSidebarOpen(true); };
    const handleCloseLostBedsSidebar = () => { setIsLostBedsSidebarOpen(false); };
